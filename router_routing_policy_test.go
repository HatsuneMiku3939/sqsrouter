...
func (testRoutingPolicy) Decide(_ context.Context, env *spec.MessageEnvelope, available []spec.HandlerKey) spec.HandlerKey { //nolint:revive
	// prefer exact match
	exact := spec.HandlerKey(env.MessageType + ":" + env.MessageVersion)
